        ...
        <aside className='w-80 space-y-6'>
          <form className='space-y-6'>
            <label
              htmlFor='video'
              className='
                border border-primary text-primary shadow-sm hover:bg-primary/80 hover:text-accent-foreground active:bg-secondary
                flex rounded-md cursor-pointer aspect-video border-dashed text-sm flex-col gap-2 items-center justify-center
              '
            >
